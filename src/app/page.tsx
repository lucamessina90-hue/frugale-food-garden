  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--cream)" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, background: "var(--teal-darker)", height: 68, padding: "0 1.5rem", display: "flex", alignItems: "center", justifyContent: "space-between", boxShadow: "0 2px 20px rgba(0,0,0,0.2)" }}>
        <Link href="/">
          <Image src="/logo-white-teal.png" alt="Frugale Food Garden" width={130} height={38} style={{ objectFit: "contain", height: 38, width: "auto" }} />
        </Link>
        <div className="nav-links-mobile">
          <Link href="/eventi" style={{ padding: "8px 14px", borderRadius: 4, background: "white", color: "var(--teal-darker)", fontWeight: 700, fontSize: "0.78rem" }}>🍽 Event Manager</Link>
          <Link href="/giardino" style={{ padding: "8px 14px", borderRadius: 4, background: "white", color: "var(--teal-darker)", fontWeight: 700, fontSize: "0.78rem" }}>🌿 Sopralluogo</Link>
          <Link href="/staff" style={{ padding: "8px 14px", borderRadius: 4, background: "white", color: "var(--teal-darker)", fontWeight: 700, fontSize: "0.78rem" }}>Staff</Link>
        </div>
      </nav>
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 1100, margin: "0 auto", padding: "4rem 1.5rem 5rem" }}>
          <div className="hero-grid">
            <div>
              ...
              <h1 className="hero-h1" style={{color:"white",fontSize:"clamp(3.5rem,6vw,5.5rem)",WebkitTextFillColor:"white"}}>
              ...
              <div className="hero-btns">
                <Link href="/eventi" style={{ padding: "13px 22px", borderRadius: 4, background: "white", color: "var(--teal-darker)", fontWeight: 700, fontSize: "0.875rem", display: "inline-flex", alignItems: "center", gap: 8 }}>
                  🍽 Parla con un Event Manager
                </Link>
                <Link href="/giardino" style={{ padding: "13px 22px", borderRadius: 4, border: "2px solid rgba(255,255,255,0.4)", color: "white", fontWeight: 600, fontSize: "0.875rem", display: "inline-flex", alignItems: "center", gap: 8 }}>
            ...
            <div className="hero-cards">
              ...
              <div style={{ background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: 12, padding: "1.1rem 1.4rem", color: "white" }}>
      ...
      {/* SERVICES */}
      <section className="section-pad" style={{ padding: "5rem 1.5rem", maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div className="services-grid">
          {[
            ...
            <div key={s.title} style={{ borderRadius: 14, overflow: "hidden", border: "1px solid var(--border)", background: "white" }}>
              <div style={{ height: 160, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "4rem", background: s.bg }}>{s.icon}</div>
              <div style={{ padding: "1.5rem" }}>
                ...
                <Link href={s.href} style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "11px 20px", borderRadius: 4, background: s.btnBg, color: "white", fontWeight: 600, fontSize: "0.85rem" }}>{s.cta}</Link>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* HOW IT WORKS */}
      <section style={{ background: "var(--teal-darker)", padding: "5rem 1.5rem", color: "white" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div className="steps-grid">
            {[
              ...
              { n: "2", title: "Inserisci i tuoi dati", desc: "Pochi campi: nome, email, telefono e dettagli. In meno di 2 minuti." },
      ...
      {/* LOCATION */}
      <section className="section-pad" style={{ padding: "5rem 1.5rem", maxWidth: 1100, margin: "0 auto" }}>
        <div className="loc-grid" style={{ background: "var(--teal-darker)", borderRadius: 18, padding: "3.5rem", color: "white" }}>
          <div>
            ...
            <p style={{ opacity: 0.7, lineHeight: 1.8, marginBottom: "2rem", fontSize: "0.9rem" }}>Raggiungiamo tutta la città e la prima cintura.</p>
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              <Link href="/eventi" style={{ padding: "11px 20px", borderRadius: 4, background: "white", color: "var(--teal-darker)", fontWeight: 700, fontSize: "0.85rem" }}>Event Manager</Link>
              <Link href="/giardino" style={{ padding: "11px 20px", borderRadius: 4, border: "2px solid rgba(255,255,255,0.4)", color: "white", fontWeight: 600, fontSize: "0.85rem" }}>Sopralluogo gratuito</Link>
            </div>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {[
              ...
              <div key={item.label} style={{ display: "flex", alignItems: "flex-start", gap: 12, background: "rgba(255,255,255,0.07)", borderRadius: 10, padding: "12px 14px" }}>
                <span style={{ fontSize: "1.1rem", flexShrink: 0 }}>{item.ic}</span>
                <div>
      ...
      {/* FOOTER */}
      <footer style={{ background: "#163335", color: "rgba(255,255,255,0.6)", padding: "3rem 1.5rem 2rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div className="footer-flex" style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "2rem", flexWrap: "wrap", gap: "1.5rem" }}>
            <div>
              <Image src="/logo-white-teal.png" alt="Frugale" width={110} height={32} style={{ objectFit: "contain", height: 32, width: "auto", opacity: 0.8 }} />
