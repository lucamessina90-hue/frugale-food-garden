    ...
    <div style={{ minHeight: "100vh", background: "var(--cream)" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
          <Link href="/eventi" style={{ padding: "9px 18px", borderRadius: 4, background: "white", color: "var(--teal-darker)", fontWeight: 700, fontSize: "0.78rem", letterSpacing: "0.03em" }}>🍽 Event Manager</Link><Link href="/giardino" style={{ padding: "9px 18px", borderRadius: 4, background: "white", color: "var(--teal-darker)", fontWeight: 700, fontSize: "0.78rem", letterSpacing: "0.03em" }}>🌿 Sopralluogo</Link><Link href="/staff" style={{ padding: "9px 18px", borderRadius: 4, background: "white", color: "var(--teal-darker)", fontWeight: 700, fontSize: "0.78rem", letterSpacing: "0.03em" }}>Staff</Link>
